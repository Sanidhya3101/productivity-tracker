// pages/api/save-interruption.js
...
export default async function handler(req, res) {
  if (req.method === 'POST') {
    ...
    const csvFilePath = path.join(csvDirectory, 'interruption_stroop.csv');
    ...
    try {
      ...
      console.error('Error writing to interruption_stroop.csv:', error);
